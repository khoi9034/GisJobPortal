...
if __name__ == "__main__":
    ...
    print(f"- alert emails checked: {result.get('alert_emails_checked', 0)}")
    ...
    print(f"- alert parse errors: {result.get('alert_parse_errors', 0)}")
    print(f"- Gmail errors: {len(result.get('gmail_errors', []))}")
