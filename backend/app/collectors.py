...
def normalize_job(raw: dict[str, Any], source: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "required_experience_years": raw.get("required_experience_years"),
        "preferred_experience_years": raw.get("preferred_experience_years"),
                    ...
                    normalize_job(
                        {
                            ...
                            "preferred_experience_years": item.get("preferred_experience_years"),
